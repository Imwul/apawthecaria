...
const journeyGoalText: Record<string, string> = {
  'Something about you changed; the road may help you process it through new places and encounters.': '당신 안의 무언가가 달라졌습니다. 새로운 장소와 조우를 거치며 그 변화를 이해하려 합니다.',
  'What changed in you, and what do you hope the road will clarify?': '당신 안에서 무엇이 달라졌고, 이 길에서 무엇을 분명히 알고 싶나요?',
  'You and your Familiar have grown apart; use this Journey to reconnect.': '당신과 길동무 사이가 멀어졌습니다. 이번 여정에서 다시 가까워지려 합니다.',
  'How have you and your Familiar grown apart, and how might you reconnect?': '길동무와 어떻게 멀어졌고, 어떻게 다시 가까워질 수 있을까요?',
  'The Guild supported you; now it is your turn to strengthen its standing.': '길드가 당신을 도왔습니다. 이제 길드의 신망을 높일 차례입니다.',
  'What do you owe the Guild, and whose trust do you hope to earn?': '길드에 어떤 빚을 졌고, 누구의 신뢰를 얻고 싶나요?',
  'A guildmate needs local conditions examined and compared.': '길드 동료가 현지 환경을 조사하고 비교해 달라고 부탁했습니다.',
  'What conditions were you asked to survey, and for whom?': '누구를 위해 어떤 환경을 조사해야 하나요?',
  'A severe injury left a beast in dire need of a Reagent.': '심한 부상을 입은 야수에게 절실한 영약재가 필요합니다.',
  'Who was injured, what happened, and what help do they need?': '누가 어떻게 다쳤고, 어떤 도움이 필요한가요?',
  'A stagnant home needs new life gathered from across the Bristley Woods.': '활기를 잃은 집에 Bristley Woods 곳곳의 새 생기를 불어넣어야 합니다.',
  'Which home needs revitalising, and what has become dull or neglected?': '어느 집에 새 활기가 필요하며, 무엇이 낡고 방치되었나요?',
  'A curious Stitcher wants patient sketches to study diverse anatomy.': '호기심 많은 Stitcher가 다양한 해부 구조를 연구할 환자 기록을 원합니다.',
  'Who requested the knowledge, and what do they hope to understand?': '누가 이 지식을 부탁했고, 무엇을 이해하려 하나요?',
  'You must convey evidence in a Branding case to the Destination.': 'Branding 판결 사건의 증거를 Destination까지 운반해야 합니다.',
  'What is the case, who was condemned, and whom does the Evidence favour?': '어떤 사건이며, 누가 유죄 판결을 받았고, Evidence는 누구에게 유리한가요?',
  'A retired Guild associate needs their essential herbs and cures restocked.': '은퇴한 길드 동료에게 공동체를 돌볼 약초와 치료제가 필요합니다.',
  'Who needs restocking, and why are they vital to their community?': '누구의 물자를 채워야 하며, 그들은 공동체에 왜 중요한가요?',
  'An old unresolved problem has been gnawing at you.': '오래전 해결하지 못한 문제가 계속 당신을 괴롭힙니다.',
  'What personal conflict remains unresolved?': '아직 해결하지 못한 개인적 갈등은 무엇인가요?',
  'Someone you know is preparing for their final Journey.': '당신이 아는 누군가가 마지막 여정을 준비하고 있습니다.',
  'Who is preparing to leave, and what farewell do you hope to give?': '누가 떠날 준비를 하고 있으며, 어떤 작별을 건네고 싶나요?',
  'A feral wind has stirred your need to explore the Bristley Woods.': '거친 바람이 Bristley Woods를 탐험하고 싶은 마음을 깨웠습니다.',
  'What has awakened your wanderlust, and what do you hope to discover?': '무엇이 방랑심을 깨웠고, 무엇을 발견하고 싶나요?',
  ...
  'Evidence is ruined if Soaked.': 'Evidence는 젖으면 훼손됩니다.',
  'Evidence, Weight 1': 'Evidence · Weight 1',
  'WOUND/INFECTION/SLEEP 3': 'WOUND, INFECTION 또는 SLEEP 3 영약재',
  'Plant Part from each Region': '각 Region의 식물 영약재 부위',
  'Three Parts with one shared Tag': '같은 Tag를 공유하는 영약재 부위 3개',
  'ELSEWHERE 2': 'ELSEWHERE 2 이상 영약재',
  ...
  'Narrative entries remain player-authored.': '갈등 기록은 플레이어가 직접 작성하고 완료를 확인합니다.',
