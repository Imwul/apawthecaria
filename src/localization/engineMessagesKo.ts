...
const exactEngineMessages: Record<string, string> = {
  ...
  "A Barter payment item cannot be spent twice.": "같은 물물교환 물품을 두 번 지불할 수 없습니다.",
  ...
  "Active treatable Ailment or Encounter Remedy instance not found.": "치료할 수 있는 진행 중인 질병 또는 조우 치료 기록을 찾지 못했습니다.",
  ...
  "Canonical Big Fish data is unavailable.": "룰북의 Big Fish 영약재 정보를 찾지 못했습니다.",
  ...
  "Choose only carried items with a printed Barter value.": "룰북에 물물교환 가치가 적힌 소지품만 선택하세요.",
  "Choose an available Tool for Inspiration.": "영감을 적용할 수 있는 도구를 선택하세요.",
  "Choose a canonical Reagent Part that can be found in the Forest.": "숲에서 발견할 수 있는 룰북 영약재 부위를 선택하세요.",
  "Choose a canonical Plant Reagent Part within the drawn Base Rarity.": "뽑은 카드의 기본 희귀도 이하인 공식 Plant 영약재 부위를 선택하세요.",
  "Choose one canonical Titan Reagent Part for Lock and Key.": "Lock and Key로 얻을 공식 Titan 영약재 부위 하나를 고르세요.",
  "Choose an eligible Inventory item to remove.": "가방에서 제거할 수 있는 물품을 선택하세요.",
  "Choose a Part from Big Fish, Small Fish, Beehive, Blackcurrant, Cucumber, Strawberries, Roses, or Wild Garlic.": "Big Fish, Small Fish, Beehive, Blackcurrant, Cucumber, Strawberries, Roses, Wild Garlic 가운데 하나의 부위를 선택하세요.",
  "Choose between 1 and 50 Reagent Parts for A Quick Cure.": "빠른 처치에 내놓을 영약재 부위를 1개에서 50개까지 선택하세요.",
  "A Quick Cure cannot trade more copies of a Part than are in the Bags.": "빠른 처치에는 가방에 든 수량보다 많은 부위를 내놓을 수 없습니다.",
  "A Quick Cure only accepts Reagent Parts providing INFECTION, BURN, or PAIN.": "빠른 처치에는 INFECTION, BURN 또는 PAIN을 제공하는 영약재 부위만 내놓을 수 있습니다.",
  ...
  "The Collector only accepts one canonical Reagent Part from the Bags.": "수집가는 가방에 든 룰북 영약재 부위 하나만 받습니다.",
  ...
  "Fixed Encounter Remedy requires stable transaction and encounter IDs.": "조우 치료를 시작하는 데 필요한 처리 정보가 없습니다.",
  "Fixed Encounter Remedy requires a patient name and species.": "조우 치료 기록에는 환자의 이름과 종이 필요합니다.",
  "Unknown fixed Encounter Remedy.": "이 조우에 해당하는 치료 정보를 찾지 못했습니다.",
  "Fixed Encounter Remedy does not belong to this Encounter.": "이 치료 기록은 현재 조우에서 시작할 수 없습니다.",
  "Fixed Encounter Remedy does not belong to this Encounter choice.": "이 치료 기록은 선택한 조우 결과에서 시작할 수 없습니다.",
  "Fixed Encounter Remedy was already started.": "이 조우 치료 기록은 이미 시작되었습니다.",
  ...
  "Lock and Key requires one carried Titan Thingamabob.": "Lock and Key에는 가방에 든 Titan Thingamabob 하나가 필요합니다.",
  "Lodge Barter skip transaction is missing or already applied.": "Lodge 물물교환 생략 처리 기록이 없거나 이미 적용되었습니다.",
  "Fluttering Fancy requires one PLANT Reagent Part.": "Fluttering Fancy에는 PLANT 영약재 부위 하나가 필요합니다.",
  "Deep Water must divide exactly 5 between all Timers and Foraging Points.": "Deep Water에서는 모든 타이머와 채집 포인트에 합계 5의 감소량을 나눠야 합니다.",
  "Funeral Rites requires one Reagent Part with ELSEWHERE.": "Funeral Rites에는 ELSEWHERE를 제공하는 영약재 부위 하나가 필요합니다.",
  "Snack Time requires one carried canonical Reagent Part.": "Snack Time에는 가방에 든 공식 영약재 부위 하나가 필요합니다.",
  "Help the Bee requires Honey or a FAIR Reagent Part for Sweet.": "Sweet를 적용하려면 Honey 또는 FAIR 영약재 부위가 필요합니다.",
  "Rescue is only available when no Honey or FAIR Reagent Part is carried.": "Rescue는 Honey와 FAIR 영약재 부위가 모두 없을 때만 적용할 수 있습니다.",
  "This purchase requires 5 Trinkets.": "이 물품을 구입하려면 장신구 5개가 필요합니다.",
  ...
  "Only a newly started Barter can skip Wander the Streets.": "새로 시작한 물물교환에서만 거리 돌아다니기를 건너뛸 수 있습니다.",
  ...
  "Treatable Ailment or Encounter Remedy definition not found.": "치료할 질병 또는 조우 치료 정보를 찾지 못했습니다.",
  ...
  "Branch-Beaten below 5 must apply exactly one marked Day.": "Branch-Beaten 카드가 5 미만이면 달력에 정확히 1일을 표시해야 합니다.",
  "Branch-Beaten 5–9 has no additional state change.": "Branch-Beaten 카드가 5–9이면 추가로 바뀌는 상태가 없습니다.",
  "Choose one canonical in-season Bog Reagent Part for Branch-Beaten.": "Branch-Beaten으로 얻을 수 있는 제철 습지 영약재 부위 하나를 고르세요.",
  "Choose the actual Branch-Beaten card range.": "실제로 뽑은 Branch-Beaten 카드 값의 구간을 고르세요.",
  "Silver Lining must add exactly one canonical Leech Reagent Part.": "Silver Lining으로 얻을 수 있는 Leech(거머리) 영약재 부위를 정확히 하나 고르세요.",
  "Eavesdrop must add exactly one weightless Juicy Gossip Guild Note.": "Eavesdrop은 무게가 없는 Juicy Gossip 길드 기록을 정확히 하나 추가해야 합니다.",
  "Piledriver Diamond result must match the Bags' current total Weight.": "Piledriver의 다이아몬드 결과는 현재 가방의 총무게와 일치해야 합니다.",
  "A safe Piledriver result does not discard any Bag items.": "Piledriver를 무사히 피한 결과에서는 가방 물품을 버리지 않습니다.",
  "Choose between 1 and 50 Bag items for the Piledriver chase.": "Piledriver에게 쫓기며 버릴 가방 물품을 1개에서 50개까지 고르세요.",
  "Every Piledriver discard must be an item currently in the Bags.": "Piledriver에게 쫓기며 버리는 물품은 모두 현재 가방에 있어야 합니다.",
  "Piledriver cannot discard more copies than are currently in the Bags.": "Piledriver에게 쫓기며 현재 가방에 든 수량보다 많이 버릴 수 없습니다.",
  "Piledriver requires discarding at least 3 total Weight.": "Piledriver에게서 달아나려면 합계 무게 3 이상을 버려야 합니다.",
  "Ancient Salvage must match the actual below-10 or 10-or-more card result.": "Ancient Salvage 결과는 실제 카드가 10 미만인지 10 이상인지와 일치해야 합니다.",
  "Choose a canonical Earth Reagent Part, then the actual card value.": "룰북의 Earth 영약재 부위 하나를 고른 뒤 실제 카드 값을 입력하세요.",
  "Pleasant Surprise must compare the card with the chosen Earth Reagent's Base Rarity.": "Pleasant Surprise는 카드 값을 고른 Earth 영약재의 기본 희귀도와 비교해야 합니다.",
  "Marsh Wader requires one carried canonical Reagent Part chosen as edible.": "Marsh Wader에는 가방에 든 룰북 영약재 부위 중 먹을 수 있다고 고른 하나가 필요합니다.",
  "Titan Thingamabob canonical Tool data is unavailable.": "룰북의 Titan Thingamabob 도구 정보를 찾을 수 없습니다.",
  "implemented": "구현됨"
};
