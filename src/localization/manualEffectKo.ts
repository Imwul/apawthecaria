...
const exactTranslations: Record<string, string> = {
  ...
  'Watch the Unveiling - Reduce Timers by 2.': '공개 지켜보기 — 타이머를 2 줄입니다.',
  'Reduce Timers by 2 as you spend time drying off and heating back up.': '몸을 말리고 몸을 덥히는 동안 타이머를 2 줄입니다.',
  'Hedgerow Wandering - Navigate around the fields; Reduce Timers by 1.': '생울타리 둘러보기 — 들판을 돌아다니며 타이머를 1 줄입니다.',
  'Reduce timers by 8.': '타이머를 8 줄입니다.',
