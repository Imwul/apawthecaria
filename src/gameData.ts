...
export const GAME_DATA = {
  "bioChoices": {
    ...
    "familiars": [
      ...
      },
      {
        "card": "J",
        "name": "유적/고분 마스터",
        "desc": "Titan 영약재의 희귀도 -2, Titan 및 고분에서 드로우 2장 중 선택"
      },
      {
        "card": "M",
        "name": "엉뚱한 조수",
  ...
  "goals": [
    ...
    },
    {
      ...
      "goalText": "Bog, Forest, Loch, Meadow, Mountain에서 각각 저널을 한 번 이상 남기기"
    }
  ],
  "ailments": [
    {
    ...
    },
    {
      ...
      "timer": 12,
      "tags": "JOY 3, NERVES 3, MOOD 3, SLEEP 3",
      "description": "Titan이 남긴 날카로운 쓰레기에 베인 탓에, 이 가여운 야수의 턱이 굳어 다물어지지 않고 고열이 시작되었습니다.",
      "outcome": "성공 보상 장신구 획득",
      "consequence": "격리 조치: 치료를 받지 못하면 열병이 그를 간호하던 다른 야수들에게로 전염됩니다. 길드는 이러한 비극의 재발을 막기 위해 근처의 Titan을 봉쇄하기로 합의했습니다. 지도에서 가장 가까운 Titan을 제거하세요."
    },
    {
    ...
    },
    {
      ...
      "description": "운 나쁘게도 쓰러지는 나무 아래에 깔려 몸 일부가 으스러지고 갇힌 피가 독성을 띠기 시작했습니다. 옮길 때는 조심해야 하지만 지체해서도 안 됩니다.",
      "outcome": "벌떡 일어나기: Steel Axe가 있거나 가까운 정착지에서 도움을 구하면 나무 아래의 환자를 꺼낼 수 있습니다. 그렇지 않다면 이 질환의 타이머를 감소시킬 때마다 1을 추가로 감소시킵니다.",
      "consequence": "짓눌림: 너무 늦었습니다. 나무의 무게를 견디지 못한 환자는 Elsewhere로 떠났습니다. 누가 이 야수를 애도할까요?"
    },
    {
      ...
      "description": "작은 긁힘과 상처로 비늘에 감염이 생겼습니다. 치료하지 않으면 감염이 피로 번집니다. 타이머가 2에 이르기 전에 해결하지 못하면 [POISON 1]은 [POISON 3]이 됩니다.",
      "outcome": "성공 보상 장신구 획득",
      "consequence": "검은 피: 감염이 퍼져 이제 당신의 능력으로는 치료할 수 없습니다. 가족과 친구들의 슬픔 때문에 마을에 머물기 어려워집니다. 다른 질환을 해결했더라도 이 질환에 실패하면 반드시 Overstay your Welcome을 적용합니다."
    },
    {
    ...
    },
    {
      ...
      "description": "잘못 만든 사워도우 한 묶음 때문에 여러 야수가 심한 경련과 아이들이 '빙글병'이라 부르는 증상을 겪습니다. 네 개의 별도 질환과 네 개의 별도 타이머로 처리하며, 치료한 환자마다 장신구와 명성을 얻습니다.",
      "outcome": "네 환자를 각각 치료하고 각 치료의 보상을 따로 받습니다.",
      "consequence": "아무도 치료하지 못하면 화가 난 야수들이 실패를 널리 알립니다. 다음 치료제에서는 장신구를 0개 받습니다."
    },
    {
      ...
      "description": "벌과 말벌을 비롯한 독침 생물에 알레르기가 있는 야수가 쏘여 몸이 붓기 시작했습니다.",
      "outcome": "위기 모면: 치료제를 두 회분 만들면 환자가 여분의 치료제를 늘 지니겠다고 약속합니다. 명성 3을 얻습니다.",
      "consequence": "떠들썩한 야수들: 환자의 친구와 가족이 지역 Hivewarden과 반목해 그들을 이주시킵니다. 이 위치에서 모든 Bee 및 Hive 영약재가 영구적으로 Unavailable이 됩니다."
    },
    {
    ...
    {
      "name": "Titan 접촉병 (Titan Touched)",
      "rawName": "PAGE 114 --- Titan Touched",
      "severity": "dire",
      "timer": 8,
      "tags": "BURN 3, NERVES 3, PAIN 3, HIDE 3",
      "description": "고대 Titan에서 흘러나오는 푸른 광물이나 이상한 소리를 내는 기계와 접촉한 탓에, 온몸의 털이 빠지고 눈동자가 비정상적으로 흐려지며 이명이 들립니다.",
      "outcome": "Titan의 계시: 성공적으로 치료한다면, 환자가 깊은 혼수상태에서 깨어나 Titan의 숨겨진 장치와 비밀번호를 읊조립니다. 지도에서 유적 탐사 시 난이도가 2 감소합니다.",
    ...
    },
    {
      ...
      "description": "공동체가 소중한 구성원을 잃었습니다. 공동체 전체가 환자이며, 함께 슬퍼하고 Elsewhere로 떠난 친구의 기억을 간직할 무언가가 필요합니다. 이 질환 중 물꼬 거래를 할 때마다 고인에 관한 이야기를 저널에 쓰고 타이머를 1 증가시킵니다.",
      "outcome": "영웅의 잔치: 치료제에 COOKED Preparation을 사용했다면 이 치료제의 명성에 +2를 받고, 고인을 기리는 거리 잔치를 기록합니다.",
      "consequence": "맥 빠진 추모: 공동체는 슬퍼하지만 고인은 곧 잊힙니다. 그가 남길 수 있었던 유산은 무엇이었을까요?"
    },
    {
    ...
    },
    {
      ...
      "description": "욕심 많은 작은 기생충이 환자의 몸 안에 들어가 몹시 굶주리게 만듭니다. 환자는 그것을 없앨 수 있는 것이라면 무엇이든 달라고 애원합니다. 이 질환에서는 [FOUL]이 [FAIR]을 상쇄하지만 추가 벌점은 주지 않습니다.",
      "outcome": "성공 보상 장신구 획득",
      "consequence": "배고픈 야수: 굶주린 환자가 지역 곡물창고를 파고들어 허기가 잠시 멎을 때까지 먹어 치웁니다."
    }
  ],
  "reagents": [
    {
