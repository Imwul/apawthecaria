...
export const GAME_DATA = {
  ...
  "ailments": [
    ...
    },
    {
      ...
      "description": "소중히 아끼던 반려동물이 저편으로 떠나는 비극을 겪은 야수입니다. 마지막 길을 정성껏 배웅할 수 있도록 당신의 도움을 바라고 있습니다.",
      "outcome": "성공 보상 장신구 획득",
      "consequence": "너무 빨리 잊힌 이: 벗의 죽음을 기릴 의식을 치르지 못하자 어두운 감정이 환자를 사로잡습니다. 이 야수는 슬픔을 어떻게 받아들이나요?"
    },
    {
