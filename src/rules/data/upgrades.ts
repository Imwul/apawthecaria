...
export type ToolUpgradeTrigger = 'forage' | 'gather' | 'ailment-start' | 'treatment' | 'pound';
...
export const TOOL_UPGRADES: readonly ToolUpgradeDefinition[] = [
  ...
  { id: 'granite-mortar', canonicalName: 'Granite Mortar and Pestle', baseToolId: 'mortar-and-pestle', weight: 1, trigger: 'pound', effect: 'POUND Plant BREW Parts into weightless Powders or Teas, up to Carry score.', ...canonicalMetadata(66), ruleIds: ['TOOL-003'] },
